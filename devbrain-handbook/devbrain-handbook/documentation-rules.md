...
## Navigation (Dev Brain map + dictionary)

This repo’s Dev Brain documentation is navigated through:
- `devbrain-handbook/devbrain-map.md` (start here)
- `devbrain-handbook/devbrain-dictionary.md` (reusable primitives)
- `devbrain-handbook/learning-loop.md` + `devbrain-handbook/registries/*` (recurring issues and fix recipes)

Rule: do not duplicate guidance across files—link to the canonical doc instead.
...
### Required upkeep for new standards

When adding a new major standard/script/playbook:
- Add it to `devbrain-handbook/devbrain-map.md`
- Add or update a primitive in `devbrain-handbook/devbrain-dictionary.md`
- If it represents a recurring failure mode, add an entry to `devbrain-handbook/registries/common-errors.md`
