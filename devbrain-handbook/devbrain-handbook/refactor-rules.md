...
- Must include “what I did not change” (invariants preserved) to reduce accidental scope creep
...
Unless the user explicitly approves a larger refactor:
- Keep refactors small and reviewable.
- Prefer one module/area at a time.
- If you discover the refactor must expand materially, stop and ask.
